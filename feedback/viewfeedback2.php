  ...
  <tr>
    ...
    <td rowspan="2" valign="top"><form id="form3" name="form3" method="post" action="">
      <div align="center" class="style2">
		...
		include("connection.php");
		$s1=$_POST["t1"];
		$s=mysql_query("select subject.subcode,subject.subname,subject.COURSENAME,subject.SEMESTER,subject.fid from subject join studentreg on subject.COURSENAME=studentreg.COURSENAME where subject.COURSENAME='$coursename'");
		if($row= mysql_fetch_array($s))
		{
		$subcode=$row[0];
		$subname=$row[1];
