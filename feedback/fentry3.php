...
<table width="1127" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="top">Question 
      <form id="form3" name="form3" method="post" action="fentry4.php">
        <?php
		$qno=0;
        ...
        <table width="283" border="1">
          ...
          <tr>
            <td height="27" colspan="2"><label>
              <input name="t4" type="radio" value="Excellent" checked="checked" />
            </label>
            Excellent 
            <label>
            <input name="t4" type="radio" value="Good" />
            </label>
            Good 
            <label>
            <input name="t4" type="radio" value="Satisfactory" />
            Satisfactory 
            <input name="t4" type="radio" value="Bad" />
            Bad</label></td>
          </tr>
          <tr>
            <td height="27" colspan="2"><label>
