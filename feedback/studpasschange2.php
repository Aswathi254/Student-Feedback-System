...
<table width="995" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top"><div align="center">
      <p>CHANGE PASSWORD</p>
      <form id="form1" name="form1" onsubmit="return abc()" method="post" action="studpasschange2.php">
          ...
          <tr>
            <td height="47" colspan="2"><label>
              <div align="center">
				...
				$s=mysql_query("select*from login where USERID='$STUDID' and PASSWORD='$s1'");
				if(mysql_num_rows($s)==0)
				echo "<b>invalid existing password";
				else 
				{
				$s="update login set PASSWORD='$s2' where USERID='$STUDID'";
				mysql_query($s);
