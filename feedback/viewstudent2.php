...
<table width="907" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top"><div align="center" class="style1">
	  ...
	  $s1=$_POST["c1"];
	  $s=mysql_query("select*from studentreg where COURSENAME='$s1'");
	  if(mysql_num_rows($s)==0)
	  echo"no student registered";
	  else
	  {
	  echo"<table border='1' width='100%'><tr><th>student Id</th><th>student name</th><th>coursename</th><th>semester</th></tr>";
